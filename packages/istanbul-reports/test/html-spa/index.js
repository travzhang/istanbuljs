...
describe("html-spa", () => {
  ...
  function createTest(file) {
    const fixture = require(path.resolve(__dirname, "../fixtures/specs/" + file));
    it(fixture.title, () => {
      ...
      assert.deepEqual(
        ...
        [
          {
            type: "copy",
            source: path.join(__dirname, "../../lib/html/assets/base.css"),
            dest: "./base.css",
            header: undefined,
          },
          {
            type: "copy",
            source: path.join(__dirname, "../../lib/html/assets/block-navigation.js"),
          ...
          },
          {
            dest: "./favicon.png",
            header: undefined,
            source: path.join(__dirname, "/../../lib/html/assets/favicon.png"),
            type: "copy",
          },
          {
            type: "copy",
            source: path.join(__dirname, "../../lib/html/assets/sort-arrow-sprite.png"),
            dest: "./sort-arrow-sprite.png",
            header: undefined,
          },
          {
            type: "copy",
            source: path.join(__dirname, "../../lib/html/assets/sorter.js"),
            dest: "./sorter.js",
            header: "/* eslint-disable */\n",
          },
          {
            type: "copy",
            source: path.join(__dirname, "../../lib/html/assets/vendor/prettify.css"),
            dest: "./prettify.css",
            header: undefined,
          },
          {
            type: "copy",
            source: path.join(__dirname, "../../lib/html/assets/vendor/prettify.js"),
            dest: "./prettify.js",
            header: "/* eslint-disable */\n",
          },
          {
            type: "copy",
            source: path.join(__dirname, "../../lib/html-spa/assets/bundle.js"),
            dest: "./bundle.js",
            header: undefined,
          },
          {
            type: "copy",
            source: path.join(__dirname, "../../lib/html-spa/assets/sort-arrow-sprite.png"),
            dest: "./sort-arrow-sprite.png",
            header: undefined,
          },
          {
            type: "copy",
            source: path.join(__dirname, "../../lib/html-spa/assets/spa.css"),
            dest: "./spa.css",
            header: undefined,
          },
        ],
  ...
  fs.readdirSync(path.resolve(__dirname, "../fixtures/specs")).forEach((file) => {
