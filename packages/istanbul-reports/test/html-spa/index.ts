...
import type { ContentWriter } from "@vitest/istanbul-lib-report";
import { afterAll as after, afterEach, assert, beforeAll as before, describe, it } from "vitest";

import HtmlSpaReport from "../../src/html-spa/index";
    ...
    it(fixture.title, () => {
      ...
      assert.deepEqual(
        ...
        [
          {
            type: "copy",
            source: path.join(import.meta.dirname, "../../src/html/assets/base.css"),
            dest: "./base.css",
            header: undefined,
          },
          {
            type: "copy",
            source: path.join(import.meta.dirname, "../../src/html/assets/block-navigation.js"),
          ...
          {
            type: "copy",
            source: path.join(import.meta.dirname, "../../src/html/assets/sort-arrow-sprite.png"),
            dest: "./sort-arrow-sprite.png",
            header: undefined,
          },
          {
            type: "copy",
            source: path.join(import.meta.dirname, "../../src/html/assets/sorter.js"),
            dest: "./sorter.js",
            header: "/* eslint-disable */\n",
          },
          {
            type: "copy",
            source: path.join(import.meta.dirname, "../../src/html/assets/vendor/prettify.css"),
            dest: "./prettify.css",
            header: undefined,
          },
          {
            type: "copy",
            source: path.join(import.meta.dirname, "../../src/html/assets/vendor/prettify.js"),
            dest: "./prettify.js",
            header: "/* eslint-disable */\n",
          },
          {
            type: "copy",
            source: path.join(import.meta.dirname, "../../src/html-spa/assets/bundle.js"),
            dest: "./bundle.js",
            header: undefined,
          },
          {
            ...
            source: path.join(
              import.meta.dirname,
              "../../src/html-spa/assets/sort-arrow-sprite.png",
            ),
            dest: "./sort-arrow-sprite.png",
            header: undefined,
          },
          {
            type: "copy",
            source: path.join(import.meta.dirname, "../../src/html-spa/assets/spa.css"),
            dest: "./spa.css",
            header: undefined,
          },
        ],
